...
{
    TMF_acre2 = "y\bc\addons\tfar\ui_scripts\";
};
        ...
        class BabelSettings : Toolbox
        {
            ...
            class Controls
            {
                ...
                class EditLanguageButtonOk : ButtonSpeakerMake
                {
                    ...
                    w = ((ATTRIBUTE_TITLE_W+ATTRIBUTE_CONTENT_W) - SIZE_M ) * GRID_W / 8;
                    x = (((ATTRIBUTE_TITLE_W+ATTRIBUTE_CONTENT_W) - SIZE_M ) * GRID_W / 8)*2.5 + SIZE_M * GRID_W;
        ...
        class RadioChannels : Toolbox
        {
            ...
            class Controls
            {
                ...
                class EditChannelRadioChooser: ctrlToolbox
                {
                    ...
                    strings[] = {
                        // BLUFOR
                        "\task_force_radio_items\anprc152\152_icon.paa",
                        "\task_force_radio_items\rf7800str\rf7800str_icon.paa",
                        "\task_force_radio_items\rt1523g\rt1523g_icon.paa",
                        "\task_force_radio_items\anarc210\anarc210_icon.paa",
                        // INDFOR
                        "\task_force_radio_items\anprc148jem\148_icon.paa",
                        "\task_force_radio_items\anprc154\154_icon.paa",
                        "\task_force_radio_items\anprc155\155_icon.paa",
                        "\task_force_radio_items\anarc164\anarc164_icon.paa",
                        // OPFOR
                        "\task_force_radio_items\fadak\fadak_icon.paa",
                        "\task_force_radio_items\pnr1000a\pnr1000a_icon.paa",
                        "\task_force_radio_items\mr3000\mr3000_icon.paa",
                        "\task_force_radio_items\mr6000l\mr6000l_icon.paa",
                        // ALL?
                        "\task_force_radio_items\bussole\bussole_icon.paa",
                    };
                    tooltips[] = {
                        // BLUFOR
                        "AN/PRC-152",
