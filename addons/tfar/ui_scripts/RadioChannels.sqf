...
switch _mode do {
    ...
    case "refreshChannelTree": {
        ...
        fn_channelTreeProcessUnit = {
            ...
            if (_giveRadio) then {
                _ctrlTree tvSetPictureRight [_location, "y\bc\addons\tfar\ui\RadioIcon_Radio_Small.paa"];
                _returnCode = 0;
            } else {
                _ctrlTree tvSetPictureRight [_location, "y\bc\addons\tfar\ui\RadioIcon_None_Small.paa"];
            };
        ...
        fn_channelTreeProcessGroup = {
            ...
            if (_giveRadio) then {
                ...
                if (_giveLeader) then {
                    _ctrlTree tvSetPictureRight [_location, "y\bc\addons\tfar\ui\RadioIcon_Leader_Small.paa"];
                    _returnCode = 2;
                } else {
                    if (_gaveSomeoneARadio) then {
                        _ctrlTree tvSetPictureRight [_location, "y\bc\addons\tfar\ui\RadioIcon_Partial_Small.paa"];
