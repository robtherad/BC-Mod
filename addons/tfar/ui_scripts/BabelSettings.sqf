...
switch _mode do {
    ...
    case "refreshLangTree": {
        ...
        fn_langTreeProcessUnit = {
            ...
            if (_doSpeak) then {
                _ctrlTree tvSetPictureRight [_location, "y\bc\addons\tfar\ui\bable_on.paa"];
                _returnCode = 0;
            } else {
                _ctrlTree tvSetPictureRight [_location, "y\bc\addons\tfar\ui\bable_off.paa"];
            };
        ...
        fn_langTreeProcessGroup = {
            ...
            if (_doSpeak) then {
                ...
                if (_hasSpeaker) then {
                    _ctrlTree tvSetPictureRight [_location, "y\bc\addons\tfar\ui\bable_partial.paa"];
